...
| **Branches** | `/branches` (POST, PUT, DELETE) | Tambah, update, dan soft-delete cabang. Akses: *Admin* |
...
| **Admin Panel** | `/products` (`POST`) | Update/tambah menu produk dan kelola master data. Akses: *Admin* |
